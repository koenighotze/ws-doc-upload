...
public class DocumentRespository {
    ...
    private static final Map<String, DocumentElem> STORE = new ConcurrentHashMap<String, DocumentElem>();

    @PostConstruct
    public void init() throws URISyntaxException, IOException {
        for (String name : Arrays.asList("CopyofHECTORGRAEME.pdf", "HECTORGRAEME.pdf")) {
    ...
    public DocumentElem newDocumentElem(String name, byte[] bytes, String mimeType, String description) {
